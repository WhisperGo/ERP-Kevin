    ...
    <div class="sidebar-wrapper active">
      <div class="sidebar-header position-relative">
        <div class="d-flex justify-content-between align-items-center">
          <div class="logo">
            <a href="<?= base_url('penilaian') ?>"><img src="<?= base_url('logo/logo_website/' . $logo->logo_website) ?>" alt="Logo" /></a>
          </div>
      ...
      <?php if (session()->get('level') == 1) { ?>
        <div class="sidebar-menu">
          <ul class="menu">
            ...
            <li class="sidebar-item <?php if ($uri->getSegment(1) == "penilaian") {
                                      echo "active";
                                    } ?>">
            ...
            <li class="sidebar-item <?php if ($uri->getSegment(1) == "nilai") {
                                      echo "active";
                                    } ?>">
            ...
            <li class="sidebar-item <?php if ($uri->getSegment(1) == "semest") {
                                      echo "active";
                                    } ?>">
