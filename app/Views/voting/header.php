...
<head>
  ...
  <link rel="shortcut icon" href="<?php echo base_url('assets/compiled/svg/obor.png') ?>" type="image/x-icon" />
  <link rel="shortcut icon" href="<?php echo base_url('assets/compiled/svg/obor.png') ?>" type="image/png" />
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/extensions/filepond-plugin-image-preview/filepond-plugin-image-preview.css') ?>" />
