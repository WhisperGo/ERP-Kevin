                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="<?= base_url('/voting/Kandidat/hilang/') ?>" style="position: absolute; top: 10px; right: 10px;">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="<?= base_url('/voting/Kandidat/balik/' . $b->id) ?>"><button class="btn btn-primary">Store Data</button></a>
                                                    </td>
                                                </tr>
                                            <?php
                                            }
