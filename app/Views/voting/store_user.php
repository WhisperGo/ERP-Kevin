                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="<?= base_url('/voting/User/hilang/') ?>" style="position: absolute; top: 10px; right: 10px;">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?= base_url('/voting/User/balik/' . $b->id_user) ?>"><button class="btn btn-primary">Store Data</button></a>
                                                    </td>
